...
describe("User List", () => {
    ...
    it("displays next page after clicking next", async() => {
        render(UserList);
        await screen.findByText("user1");
        const page = screen.queryByText("next >");
    ...
    it("does not displays previous page link in the first page", async() => {
        render(UserList);
        await screen.findByText("user1");
    ...
    it("displays previous page after clicking previous", async() => {
        render(UserList);
        await screen.findByText("user1");
...
describe("Internationalization", () => {
    ...
    it("initially displays header and navigation links in japanese after selecting the language", async() => {
        setup()
        await screen.findByText("user4")
        await userEvent.click(japaneseToggle)
        expect(screen.queryByText(ja.users)).toBeInTheDocument();
        expect(screen.queryByText(ja.nextPage)).toBeInTheDocument();
        expect(screen.queryByText(ja.previousPage)).toBeInTheDocument();
    })
})
